...
public class BadModule extends AbstractModule
{
    ...
    public BadModule(OkHttpClient okHttpClient, Supplier<Applet> clientLoader, RuntimeConfigLoader configSupplier, boolean developerMode, boolean safeMode, File sessionfile, File config) {
    ...
    {
        // bind properties
        Properties properties = BadProperties.getProperties();
