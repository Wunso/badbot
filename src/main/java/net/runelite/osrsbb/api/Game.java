...
import net.runelite.osrsbb.internal.globvals.VarcIntIndices;
import net.runelite.osrsbb.internal.globvals.VarcIntValues;
...
import net.runelite.osrsbb.script.LoginBot;
...
public class Game extends MethodProvider {
    ...
    public Boolean inRandom() {
        for (Random random : methods.badLite.getScriptHandler().getRandoms()) {
     ...
     */
    public static GameState getClientState() {
     ...
     */
    public int getWidth() {
        return methods.badLite.getCanvas().getWidth();
    }
    ...
    public int getHeight() {
        return methods.badLite.getCanvas().getHeight();
    }
