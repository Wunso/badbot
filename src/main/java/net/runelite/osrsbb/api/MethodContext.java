...
import net.runelite.osrsbb.api.game.Combat;
...
import net.runelite.osrsbb.internal.input.VirtualKeyboard;
import net.runelite.osrsbb.internal.input.VirtualMouse;
import net.runelite.osrsbb.wrappers.subwrap.ChooseOption;
import net.runelite.osrsbb.wrappers.subwrap.NPCChat;
...
public class MethodContext {
	 ...
	 * @param badLite The client to provide method contexts for
	 */
	public MethodContext(BadLite badLite) {
		this.badLite = badLite;
		this.client = new RSClient(badLite.getInjector().getInstance(Client.class), badLite.getInjector().getInstance(ClientThread.class));
		this.inputManager = badLite.getInputManager();
	}
}
