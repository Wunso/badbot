...
import net.runelite.osrsbb.internal.listeners.PassiveScriptListener;
import net.runelite.osrsbb.launcher.BadLite;
import net.runelite.osrsbb.script.PassiveScript;
import net.runelite.osrsbb.script.PassiveScriptManifest;
...
public class PassiveScriptHandler {
    ...
    public PassiveScriptHandler(BadLite bot) {
        this.bot = bot;
    }
