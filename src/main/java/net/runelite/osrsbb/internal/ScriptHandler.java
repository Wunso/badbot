...
public class ScriptHandler {
    private final ArrayList<net.runelite.osrsbb.script.Random> randoms = new ArrayList<>();
    ...
    public ScriptHandler(BadLite bot) {
        this.bot = bot;
    }
    ...
    public void init() {
        ...
        for (net.runelite.osrsbb.script.Random r : randoms) {
    ...
    public Collection<net.runelite.osrsbb.script.Random> getRandoms() {
        return randoms;
    }
    ...
    public void updateInput(BadLite bot, int mask) {
        for (ScriptListener l : listeners) {
