...
public class Application {
    static BadLiteInterface[] bots = new BadLiteInterface[]{};
    ...
    public static void setBot(int index) {
        BadLiteInterface bot = getBots()[index];
    }
     ...
     */
    public static BadLiteInterface getBot(Object o) {
        ClassLoader cl = o.getClass().getClassLoader();
        for (BadLiteInterface bot : bots) {
    ...
    public static void addBot(boolean headless) {
        ...
        BadLiteInterface[] update = new BadLiteInterface[bots.length + 1];
     ...
     */
    public static BadLiteInterface[] getBots() {
        return bots;
    }
