...
public class BadClassLoader extends ClassLoader {
    ...
    private static class ChildClassLoader extends ClassLoader
    {
        ...
        public Class<?> findClass(String name) throws ClassNotFoundException
        {
            ...
            try {
                ...
                if (name.equals("net.runelite.osrsbb.launcher.BadLiteInterface") ||
                    name.startsWith("net.runelite.osrsbb.internal.globval.GlobalConfiguration") ||
    ...
    public BadClassLoader(String name)
    {
