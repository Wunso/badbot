package net.runelite.osrsbb.plugin;

import net.runelite.osrsbb.internal.LogFormatter;
import net.runelite.osrsbb.internal.globvals.GlobalConfiguration;
import net.runelite.osrsbb.util.StringUtil;
...
public class LogTextArea extends JList  {
    ...
    private class LogAreaListModel extends AbstractListModel {
        ...
        private java.util.List<WrappedLogRecord> records = new ArrayList<>(
                LogTextArea.MAX_ENTRIES);

        public void addAllElements(java.util.List<WrappedLogRecord> obj) {
            records.addAll(obj);
    ...
    private class LogQueue implements Runnable {
        ...
        private java.util.List<WrappedLogRecord> queue = new ArrayList<>(
                100);
