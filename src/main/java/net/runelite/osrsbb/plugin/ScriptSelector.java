...
import net.runelite.osrsbb.service.FileScriptSource;
import net.runelite.osrsbb.service.ScriptDefinition;
import net.runelite.osrsbb.service.ScriptSource;
import net.runelite.osrsbb.service.ServiceException;
...
public class ScriptSelector extends JDialog implements ScriptListener {
     ...
     */
    public ScriptSelector(BadLite bot) {
     ...
     * @param bot	the bot instance
     */
    public ScriptSelector(Frame frame, BadLite bot) {
