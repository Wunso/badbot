...
public class ScreenshotUtil {
    ...
    public static void saveScreenshot(final BadLite bot, final boolean hideUsername) {
    ...
    private static void saveScreenshot(final BadLite bot, final File file, final String type, final boolean hideUsername) {
        try {
    ...
    public static BufferedImage takeScreenshot(final BadLite bot, final boolean hideUsername) {
